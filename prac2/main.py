...
print(f"Name of system: {my_system.node}")
print(f"Operating System Name: {my_system.system}")
# print(f"Release: {my_system.release}")
print(f"Operating System Version: {my_system.version}")
...
if __name__ == '__main__':
    ...
    print("Time elapsed:", elapsed_time/t_default)
